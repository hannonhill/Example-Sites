                    ...
                    <xsl:when test="$recentCreates &gt; 0">
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-condensed" id="reportTable">
                                ...
                                <tbody>
                                    <xsl:apply-templates select="system-index-block/system-page[system-data-structure/block/content/system-index-block//system-page[created-on&gt;$timestamp][not(@current)]]">
