<xsl:stylesheet
    ...
    <xsl:template match="/">
        <xsl:variable name="recentPublishes" select="count(system-index-block/system-page/system-data-structure/block/content/system-index-block//system-page[last-published-on&gt;$timestamp][not(@current)])"/>
        <div class="row">
            <div class="col-xs-12">
                <h1>
    ...
    <xsl:template match="system-page">
        <tr>
            ...
            <td>
                <xsl:value-of select="count(system-data-structure/block/content/system-index-block//system-page[last-published-on&gt;$timestamp][not(@current)])"/>
            </td>
            <td>
